  ...
  useEffect(() => {
    const loadDashboardData = async () => {
      try {
        ...
        // Mock job matching based on user skills (if available)
        setTimeout(() => {
          ...
          // Calculate stats
          const stats = mockApplications.reduce(
            (acc, app) => {
              ...
              else if (app.status === "offer") acc.offers++;
              ...
              >
                <div className="p-6">
                  ...
                  <p className="mb-6 text-blue-100">
                    ...
                    with the perfect job by 85%
                  </p>
                  <div className="w-full bg-white bg-opacity-20 h-2.5 rounded-full mb-3">
                    <div
